...
import spbu_coding.graph_analyzer.model.impl.algorithm.decorator.batchIterations
import spbu_coding.graph_analyzer.model.impl.algorithm.decorator.trackIterationsPerSecond
...
object LayoutAlgorithmCategory : GraphAlgorithmCategory {
    ...
    override fun createAlgorithms(graph: Graph<Vertex>) = listOf(
        ForceAtlas2(graph).trackIterationsPerSecond().batchIterations(),
        RandomLayoutAlgorithm(graph)
    )
}
